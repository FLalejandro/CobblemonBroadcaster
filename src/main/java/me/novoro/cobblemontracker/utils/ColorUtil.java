...
public final class ColorUtil {
    ...
    public static String toJson(Text text) {
        return Text.Serialization.toJsonString(text, CobblemonTracker.getServer().getRegistryManager());
    }

    public static Text fromJson(String json) {
        return Text.Serialization.fromJson(json, CobblemonTracker.getServer().getRegistryManager());
    }
